...
annotation_types = [
    ...
    "kemasan",
    "agar2",
      # e.g., sun or moon as to not confuse them with artificial lighting
]
...
filelist = [
    "assets/baticrom/!Coconut%20Vinegar%20(Srilanka)%20P5140009-800x1040.jpg",
    "assets/baticrom/!Coconut%20Vinegar%20(Srilanka)%20P5140009-800x1040.jpg",
    "assets/baticrom/ABC%20Kecap%20Asin%20DSC02643-800x1040.jpg",
    "assets/baticrom/ABC%20Sambal%20Asli%20DSC02653-800x1040.jpg",
    "assets/baticrom/AgarAgar(Chocolate)%20DSC02818-800x1040.jpg",
    "assets/baticrom/AlooBhujia(Haldiram)%20DSC02924-800x1040.jpg",
    "assets/baticrom/ApricotNectar(Tamek)1000ml%20DSC06491-800x1040.jpg",
    "assets/baticrom/AsamJawa(Adabi)%20DSC03231-800x1040.jpg",
    "assets/baticrom/AyamGoreng(bamboe)%20P9190589-800x1040.jpg",
    "assets/baticrom/AyamGoreng(Kokita)%20DSC03279-800x1040.jpg",
]
